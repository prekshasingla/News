...
public class NewsSyncAdapter extends AbstractThreadedSyncAdapter {
     ...
     */
        ...
        try {
            ...
            Uri builtUri = Uri.parse(NEWS_BASE_URL).buildUpon()
                    .appendQueryParameter(SOURCE_PARAM, "techcrunch")
    ...
    public static void configurePeriodicSync(Context context, int syncInterval, int flexTime) {
        ...
        String authority = "com.example.prekshasingla.news.app";
    ...
    public static void syncImmediately(Context context) {
        ...
        ContentResolver.requestSync(getSyncAccount(context),
                "com.example.prekshasingla.news.app", bundle);
    }
    ...
    private static void onAccountCreated(Account newAccount, Context context) {
         ...
         */
        ContentResolver.setSyncAutomatically(newAccount, "com.example.prekshasingla.news.app", true);
